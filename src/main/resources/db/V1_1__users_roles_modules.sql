...
(
    id      BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, -- unique location identifier
...
(
    id   BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, -- unique module identifier
...
CREATE TABLE roles
(
    id   BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, -- unique role identifier
