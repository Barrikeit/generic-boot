...
import org.barrikeit.config.security.service.dto.RegisterDto;
...
public class BasicUserDetailsService {
  ...
  public RegisterDto register(final RegisterDto registerDto) {
    UserDto dto =
        userService.save(
            UserDto.builder()
                ...
                .build());
    return new RegisterDto(dto.getUsername(), dto.getEmail(), dto.getPassword());
  }
